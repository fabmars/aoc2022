...
public class Aoc20221205_1 {
  ...
  public static void main(String[] args) throws IOException {
    ...
    try(BufferedReader br = new BufferedReader(new InputStreamReader(Aoc20221205_1.class.getResourceAsStream("/1205-cranes.txt")))) {
      String line;
      ...
      while((line = br.readLine()) != null) {
        ...
        for (int n = 0; n < num; n++) {
          String crate = (String) lanes[from - 1].remove(0);
          lanes[to-1].add(0, crate);
        }
      }
    }
